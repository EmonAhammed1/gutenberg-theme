...
if ( ! function_exists( 'realome_scripts' ) ) :
	...
	function realome_scripts() {
		...
		wp_add_inline_style( 'realome-style', 'header a[href*="tel"], header p:has(a[href*="tel"]), header .vhs-header-phone-wrap, header .wp-block-buttons, header .wp-block-button, header .vhs-header-right-actions, header div:has(> .wp-block-buttons), header div:has(a[href*="tel"]), .wp-site-blocks header .wp-block-buttons, .wp-site-blocks header a[href*="tel"] { display: none !important; visibility: hidden !important; opacity: 0 !important; width: 0 !important; height: 0 !important; margin: 0 !important; padding: 0 !important; pointer-events: none !important; } @media (max-width: 992px) { header .wp-block-group.is-nowrap, header div.is-nowrap.wp-block-group, header .wp-block-group.alignwide > .wp-block-group:has(.wp-block-button), header .wp-block-group.alignwide > .wp-block-group:has(a[href*="tel"]), header .wp-block-group.alignwide > .wp-block-group:last-of-type, header .wp-block-group.alignwide > div:last-child:not(.is-responsive), header .wp-block-group:has(> .wp-block-buttons), header .wp-block-group:has(> a[href*="tel"]), header .wp-block-group:has(> p > a[href*="tel"]) { display: none !important; } }' );
